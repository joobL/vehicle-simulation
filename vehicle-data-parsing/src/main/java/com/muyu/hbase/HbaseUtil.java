...
public class HbaseUtil {
     ...
     * @return
     */
    public static boolean isTableExist(String tablesName){
     ...
     * @param nameSpace
     */
    public static void createTableSpace(String nameSpace){
     ...
     * @throws IOException
     */
    public static List<String> getColumnFamiliesName(String tableName)throws IOException{
     ...
     * @throws IOException
     */
    public static void insertAll(String tableName, String rowKey,String columnFamily, Map<String,String> mapData) throws IOException {
        Table table = conn.getTable(TableName.valueOf(tableName));
        List<Put> puts = new ArrayList<>();
